...
- **Weindaten aus dem Netz** – Mit einem kostenlosen Key von wineapi.io lässt sich jeder Wein auf der Detailseite nachschlagen: Bewertung, Kritikerpunkte, Beschreibung, Preisspanne und Speiseempfehlungen, einmal geholt und dann gespeichert. Die Empfehlungen nutzt der Wein-Berater wie die vom Etikett, ohne KI-Anfrage. Beschreibung und Empfehlungen werden auf dem Gerät ins Deutsche übersetzt, wenn das Sprachpaket installiert ist.
