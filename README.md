...
- **Notizen nachträglich übersetzen** – Für Weine, die vor der automatischen Übersetzung erfasst wurden, gibt es in den Einstellungen einen einmaligen Durchlauf. Er läuft ausschliesslich auf dem Gerät, ohne Anfrage an einen KI-Anbieter und ohne Kosten, und schliesst archivierte Weine ein. Vorher nennt die App, wie viele Notizen betroffen sind; fehlt für eine Sprache das Paket, bleibt der Text unverändert stehen.
